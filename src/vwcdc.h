...
void setup_rmt_input()
{
    ...
    xTaskCreate(my_task, "rmt_decoder", 2048, NULL, 5, NULL);
...
void process_command(uint8_t cmd)
{
    ...
    xQueueSend(command_queue, &cmd, CMD_QUEUE_TIME);
}
...
void vwcdc_loop()
{
    for (;;)
    {
        ...
        delay_ms(5); // Guessed! TODO
    }
}

void vwcdc_start(void *parameters)
{
    vwcdc_setup();
    vwcdc_loop();
